...
<  form   method = " post " >
  <  table   width = " 100% " height = " 317 " border = " 0 " >
    <  tr  >
      ...
      <  td   width = " 70% " >
	      <  B  > Soit </  b  >   <  a   href = " mailto: <?  Php   echo   $ le contact avec -> webmaster ; ?> " > Cliquez ici pour Envoyer un mail Directement </  a  >  <  br />
        <  B  > Ou </  b  > s'il vous plaît le REMPLIR Formulaire de contact: <  br />
	    </  td  >
    </  tr  >
    <  tr  >
      <  td   width = " 30% " align = " right " valign = " middle " >
